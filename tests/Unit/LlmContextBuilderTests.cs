...
public class LlmContextBuilderTests
{
    ...
    public void Build_IncludesFactsSection()
    {
        ...
        var result = LlmContextBuilder.Build("", facts, [], "msg");
    ...
    public void Build_IncludesRecentMessagesSection()
    {
        ...
        var result = LlmContextBuilder.Build("", [], buffer, "new msg");
    ...
    {
        var result = LlmContextBuilder.Build("", [], [], "Can you send photos?");
    ...
    {
        var result = LlmContextBuilder.Build("", [], [], "Hi!");
    ...
    {
        var result = LlmContextBuilder.Build("summary", [Fact("k", "v")], ["buffer"], "incoming");
